      ...
      req.on('end', async () => {
        ...
        try {
          ...
          if (req.url.startsWith('/browser/')) {
            ...
            const fn = { open: ba.agentOpen, read: ba.agentRead, find: ba.agentFind, act: ba.agentAct, eval: ba.agentEval, html: ba.agentHtml, upload: ba.agentUpload, save_flow: ba.agentSaveFlow, see: ba.agentSee, state: ba.agentState, cookie: ba.agentCookie, tabs: ba.agentTabs, resize: ba.agentResize, assert: ba.agentAssert, shot: ba.agentShot, diag: ba.agentDiag, close: ba.agentClose }[route]
