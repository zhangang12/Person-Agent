      ...
      req.on('end', async () => {
        ...
        try {
          ...
          if (req.url.startsWith('/browser/')) {
            ...
            const fn = { open: ba.agentOpen, read: ba.agentRead, find: ba.agentFind, act: ba.agentAct, assert: ba.agentAssert, shot: ba.agentShot, diag: ba.agentDiag, close: ba.agentClose }[route]
