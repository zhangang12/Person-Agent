...
<template>
  <details class="k-think" :open="item.open" @toggle="onToggle">
    <summary><svg class="chev" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 6l6 6-6 6"/></svg>{{ item.title || '思考过程' }}</summary>
